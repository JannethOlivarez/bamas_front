...
export class AppMenuComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit() {
        this.model = [
            ...
            {
                label: 'Personas', icon: 'settings',
                items: [
                    {label: 'Doctor', icon: 'view_quilt',  routerLink: ['/administracion/doctor']},
                    {label: 'Militar', icon: 'flip_to-front', routerLink: ['/administracion/militar']},
                    {label: 'Civil', icon: 'label', routerLink: ['/administracion/civil']}
                ]
            },
            {
